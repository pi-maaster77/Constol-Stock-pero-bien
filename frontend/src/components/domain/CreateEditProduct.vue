            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="priceformula" id="priceformula" class="form-select" v-model="priceFormula">
                    ...
                    <div class="form-check mb-3">
                        <input type="checkbox" name="expires" id="expires" class="form-check-input" v-model="expires">
                ...
                <div class="modal-footer">
                        <button type="button" class="btn btn-primary" @click="save" v-if="props.product">Guardar</button>
